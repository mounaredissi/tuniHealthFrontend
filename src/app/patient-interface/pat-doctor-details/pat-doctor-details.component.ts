...
@Component({
  ...
  styleUrls: ['./pat-doctor-details.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class PatDoctorDetailsComponent implements OnInit {
  ...
  public ngOnInit(): void {
    this.dataService.updateActiveItem('pat-doctors');
  ...
  public onBackIconClick(): void {
    this.router.navigateByUrl('/pat-doctors');
  }
